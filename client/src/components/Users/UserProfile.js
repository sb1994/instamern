...
class UserProfile extends Component {
  ...
  componentDidMount() {
    ...
    if (match.params.id === auth.user._id) {
      ...
      this.props.getSelectedFeedPosts(auth.user._id)
    } else {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevState.action !== this.props.match.params.action) {
      ...
      console.log(prevProps, this.props.post)
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (!nextProps.auth.isAuthenticated) {
      ...
      // this.props.getSelectedFeedPosts(id)
            ...
            <div className='col-12'>
              ...
              {action === 'posts' ? (
                <Fragment>
                  ...
                  <PostList feed_id={searchedUser._id} />
                  {/* <p>{searchedUser._id}</p> */}
                </Fragment>
              ) : (
                ''
              )}
